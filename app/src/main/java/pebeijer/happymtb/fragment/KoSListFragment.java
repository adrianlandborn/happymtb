...
import pebeijer.happymtb.adapter.ListKoSAdapter;
import pebeijer.happymtb.helpers.Utilities;
import pebeijer.happymtb.item.KoSData;
import pebeijer.happymtb.item.KoSItem;
import pebeijer.happymtb.listener.KoSListListener;
import pebeijer.happymtb.task.KoSImageDownloadTask;
import pebeijer.happymtb.task.KoSListTask;
...
public class KoSListFragment extends ListFragment implements DialogInterface.OnCancelListener {
	...
	public void onCreateOptionsMenu(Menu menu, MenuInflater inflater) {
		menu.clear();		
		inflater.inflate(R.menu.kosmenu, menu);
