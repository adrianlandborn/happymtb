...
import pebeijer.happymtb.adapter.ListMessagesAdapter;
import pebeijer.happymtb.helpers.Utilities;
import pebeijer.happymtb.item.Message;
import pebeijer.happymtb.item.MessageData;
import pebeijer.happymtb.listener.MessageListListener;
import pebeijer.happymtb.task.MessageImageDownloadTask;
import pebeijer.happymtb.task.MessageListTask;
