...
import pebeijer.happymtb.view.CalendarRowView;
...
public class ListCalendarAdapter extends BaseAdapter {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if (mCalendarItems.get(position).getCategory().contains("Event/Mässa")) {
			identifier = mContext.getResources().getIdentifier("rowshapeevent", "drawable","pebeijer.happymtb");
		} else if (mCalendarItems.get(position).getCategory().contains("Happyride")) {
			identifier = mContext.getResources().getIdentifier("rowshapehappyride", "drawable","pebeijer.happymtb");
		} else if (mCalendarItems.get(position).getCategory().contains("Motionslopp/Tävling")) {
			identifier = mContext.getResources().getIdentifier("rowshapemotion", "drawable","pebeijer.happymtb");
		} else if (mCalendarItems.get(position).getCategory().contains("Svartrejs")) {
			identifier = mContext.getResources().getIdentifier("rowshapesvartrejs", "drawable","pebeijer.happymtb");
		} else {
			identifier = mContext.getResources().getIdentifier("rowshapeovrigt", "drawable","pebeijer.happymtb");
		}
