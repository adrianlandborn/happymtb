...
public class KoSObjectRequest extends Request<KoSObjectItem> implements Response.Listener<KoSObjectItem> {
    ...
    private Response.Listener<KoSObjectItem> mKoSObjectListener;
	...
	public KoSObjectRequest(String url, Response.Listener<KoSObjectItem> listener, Response.ErrorListener errorListener) {
		...
		mKoSObjectListener = listener;
	}

	public void removeKoSObjectListener() {
		mKoSObjectListener = null;
	}
	...
	private KoSObjectItem extractKoSObject(String str) {
		...
		return new KoSObjectItem(area, town, type, title, person, publishDate, imgLinkList, description, price, yearModel, getUrl(), ""/*category not available*/);
	}
	...
	@Override
	protected void deliverResponse(KoSObjectItem response) {
        if (response != null) {
