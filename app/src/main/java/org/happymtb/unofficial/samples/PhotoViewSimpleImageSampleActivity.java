 ...
 *******************************************************************************/
package org.happymtb.unofficial.samples;
...
public class PhotoViewSimpleImageSampleActivity extends AppCompatActivity {
...
//        mImageView.setImageDrawable(bitmap);
    ...
    public boolean onPrepareOptionsMenu(Menu menu) {
        ...
        zoomToggle.setTitle(mAttacher.canZoom() ? "Disable Zoom" : "Enable Zoom");
    ...
    private void showToast(CharSequence text) {
        ...
        mCurrentToast = Toast.makeText(PhotoViewSimpleImageSampleActivity.this, text, Toast.LENGTH_SHORT);
        mCurrentToast.show();
    }
